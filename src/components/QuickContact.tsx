      ...
      <CardContent className="p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <a href="tel:0636374035" className="text-gray-700 hover:text-blue-600 transition-colors">
              06-36374035
            </a>
          </div>
          <div className="flex items-center gap-3">
            ...
            <a href="mailto:info@mas-services.nl" className="text-gray-700 hover:text-blue-600 transition-colors">
