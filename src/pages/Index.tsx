            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="space-y-6">
                ...
                <div className="text-3xl lg:text-4xl font-bold text-gray-800 leading-relaxed">
                  <span className="text-blue-600">Administratieve diensten</span>
                  <br />
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
              <Button size="lg" variant="secondary" className="bg-white text-blue-600 hover:bg-gray-50 px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                <Link to="/contact" className="flex items-center gap-2">
                  Neem Contact Op
                  <ArrowRight className="h-5 w-5" />
                </Link>
